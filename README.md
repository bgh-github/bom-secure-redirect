...
Lesser known is the BOM seem to have long made a HTTPS enabled mirror of the site available at https://reg.bom.gov.au. Enter this extension.

More recently, the extension switched to taking advantage of the BOM enabling (but not auto redirecting to) HTTPS for www<span/>.bom.gov.au as of around mid 2025.
